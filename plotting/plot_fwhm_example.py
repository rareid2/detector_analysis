...
ff2 = ax14.imshow(
    np.loadtxt(thick_dc_edge)[0:19, 122:142] / max_dc, cmap, vmin=0, vmax=1
)
...
rect = plt.Rectangle(
    (62, 59), 18, 18, fill=False, edgecolor="lightgrey", linewidth=1, linestyle="--"
)
ax2.add_patch(rect)
...
rect = plt.Rectangle(
    (122, 0), 18, 18, fill=False, edgecolor="lightgrey", linewidth=1, linestyle="--"
)
ax6.add_patch(rect)
rect = plt.Rectangle(
    (122, 0), 18, 18, fill=False, edgecolor="lightgrey", linewidth=1, linestyle="--"
...
t.set_bbox(dict(facecolor="white", edgecolor="white"))
t = ax7.text(1.5, 1.5, "f)", fontsize=10, va="center", ha="center")
t.set_bbox(dict(facecolor="white", edgecolor="white"))
