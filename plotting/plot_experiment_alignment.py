...
if isotope == "background":
    ...
    vmaxes = [3, 2e3]
    plot_alignment(resampled_data_list=resampled_data_list, deconvolved_images=deconvolved_images, vmaxes=vmaxes, save_name=plot_fname)
    #plot_four_subplots(
    #    raw_data=raw_data,
    #    cleaned_data=cleaned_data_all,
    #    resampled_data=resampled_data,
